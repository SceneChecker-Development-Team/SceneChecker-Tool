...
def transform_poly_from_virtual(poly, transform_information):
    ...
    return poly.translation(translation_vector) # out_poly
...
if __name__ == "__main__":
    wp = Waypoint('follow_waypoint', [48.742640687118424, 79.98528137424009, 0, 51.74264068711783, 79.98528137424009, 0], 10, 0)
    print(TC_Simulate(wp, 0.01, [48.49264, 79.79663, -0.34802, -0.90175, -1.21412, -1.32]))